#!/bin/bash
# start.command — Doppelklick-Start für den Werkbank-Einstieg "werkbank-leer" (@dpa ddw.md
# 20260803_135251 Punkt 5, s. tools/new-entry.mjs buildStartScript() — dort für jeden neu
# geklonten Einstieg automatisch erzeugt; dieser hier von Hand nachgezogen, weil
# werkbank-leer/ als einer der zwei Original-Einstiege nicht über new-entry.mjs entsteht).
# Liegt IM Einstiegs-Ordner — "$(dirname "$0")/.." ist darum das Projekt-Root, unabhängig
# davon, wohin der Ordner verschoben/kopiert wird.
