/**
 * pitch-osz.js – baut pitch-osz/index.html auf (URL /pitch-osz): der ZWEITE,
 ...
 * das Präfix dieses Einstiegs (pitch-osz_*, aus <html data-app>, s. lib/appId.js), der
 * Erstbesuch-Stand kommt aus presets/pitch-osz-config.json. BIS DAHIN teilte sich
...
// die will ich auch in beiden, pitch-osz und overcord") ────────────────────────────
...
// hier fasst also nur pitch-osz-Daten an, nicht die von index.html.
