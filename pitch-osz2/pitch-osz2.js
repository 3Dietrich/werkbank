/**
 * pitch-osz2.js – baut pitch-osz2/index.html auf (URL /pitch-osz2): der ZWEITE,
 ...
 * das Präfix dieses Einstiegs (pitch-osz2_*, aus <html data-app>, s. lib/appId.js), der
 * Erstbesuch-Stand kommt aus presets/pitch-osz2-config.json. BIS DAHIN teilte sich
...
//
// NUR im Original pitch-osz2 sichtbar (@dpa ddw.md 20260803_122138 Punkt 3: "die zentrale
...
// String-Vergleich `APP === 'pitch-osz2'` HIER wäre falsch — new-entry.mjs schreibt beim
// Kopieren JEDES Vorkommen von `sourceSlug` (Default exakt der String "pitch-osz2") in
// DIESER Datei blind auf den neuen Slug um (`js.split(sourceSlug).join(slug)`, s. dortiger
// Kopf). Ein hier stehendes `'pitch-osz2'`-Literal würde also im Klon MIT umgeschrieben
...
// die will ich auch in beiden, pitch-osz2 und overcord") ────────────────────────────
...
// hier fasst also nur pitch-osz2-Daten an, nicht die von index.html.
...
// kommen ODER schon aus der mitgelieferten Demo (presets/pitch-osz2-config.json trägt für
...
// `.isConnected` statt nur der Variable: im Klon (APP !== 'pitch-osz2') wurde die Karte
