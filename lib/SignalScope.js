...
export class SignalScope {
    ...
    /** Welche Quelle abgelesen wird — {module, port} (aus routing.outputSources()) oder
     *  null (keine Quelle, Scope zeigt nichts). Setzt NIE etwas an der Quelle selbst. */
    setSource(ref) { this._srcRef = ref; this.reset(); }
