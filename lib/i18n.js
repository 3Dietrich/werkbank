...
const EN = {
    ...
    // WaveShaper-Soft-Clip (lib/MasterVolume.js, @dpa ddw.md 20260802) – Sicherheitsnetz nach dem Limiter.
    'WaveShaper-Soft-Clip — zusätzliches, weiches Sicherheitsnetz NACH dem Limiter (tanh-Sättigung statt harter Begrenzung).':
        'WaveShaper soft clip — an extra, gentle safety net AFTER the limiter (tanh saturation instead of a hard limit).',
