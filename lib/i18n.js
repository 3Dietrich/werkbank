...
const EN = {
    ...
    'Cut⇢Base': 'Cut⇢Base',
    'Band': 'Band',
    'Metro-Cutoff folgt der Base-Frq (in [Band, 2·Band] gefaltet) statt dem Cutoff-Knob.':
        'Metro cutoff follows the base freq (folded into [band, 2·band]) instead of the cutoff knob.',
    'Nur bei „Cut⇢Base": der Metro-Cutoff ist die in [L, 2L) gefaltete Base-Frq — L ist diese untere Bandgrenze.':
        'Only with "Cut⇢Base": the metro cutoff is the base freq folded into [L, 2L) — L is this lower band edge.',
