...
const EN = {
    ...
    'Ausgangspegel des Ensembles (dBFS, Peak-Hold) — Rechtsklick auf ein Meter: Quelle/Aussehen/+➚/🚮.':
        'Output level of the ensemble (dBFS, peak hold) — right-click a meter: source/appearance/+➚/🚮.',
