...
// ADSR-Settings (für groupKindSettings-Hook in pitchosc.js)
...
export function adsrOscDefs({ onAction } = {}) {
    return {
        ...
        GROUPS: [
            ...
            { name: 'Amp-ADSR', groupKind: 'ADSR-Amp', knobs: ['adsrA', 'adsrD', 'adsrS', 'adsrR', 'adsrPeak', 'adsrLenMs', 'adsrLenBeat'], toggles: ['adsrAOn', 'adsrDOn', 'adsrSOn', 'adsrROn', 'adsrInv', 'adsrVerlauf'], segments: ['adsrTrigMode'], buttons: ['adsrLenFest'] },
            { name: 'Pitch-ADSR', groupKind: 'ADSR-Pitch', knobs: ['adsrA_p', 'adsrD_p', 'adsrS_p', 'adsrR_p', 'adsrPeak_p', 'adsrLenMs_p', 'adsrLenBeat_p'], toggles: ['adsrAOn_p', 'adsrDOn_p', 'adsrSOn_p', 'adsrROn_p', 'adsrInv_p', 'adsrVerlauf_p'], segments: ['adsrTrigMode_p'], buttons: ['adsrLenFest_p'] },
        ],
    };
}