...
export class ElementSettings {
  ...
  _build() {
    ...
    const live = ['.es-label', '.es-labelon', '.es-labelpos', '.es-btnmode', '.es-size', '.es-fontsize', '.es-boxsize', '.es-boxh', '.es-gap', '.es-beatsize', '.es-radius', '.es-pad', '.es-texton', '.es-textoff', '.es-textblink', '.es-memcols', '.es-memrows', '.es-slotsize', '.es-layertop'];
    live.forEach((sel) => {
  ...
  _fieldsFor(type, hasBlink) {
    ...
    if (type === 'stepseq') return ['bg', 'fg', 'boxSize', 'boxH'];
