...
// Default-Key mit dem Präfix DIESES Einstiegs (@dpa dd.md 20260801_2, s. lib/appId.js) —
// für index.html unverändert 'werkbank_state', weil 'werkbank' der data-app-Default ist.
// Die Einstiegsdateien geben ihren Key ohnehin explizit mit (lsKey('state')); das hier ist
// nur die Rückfallebene, damit ein `new MiniState()` nicht in einem fremden Topf landet.
const LS_KEY = lsKey('state');
