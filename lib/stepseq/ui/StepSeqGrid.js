...
export class StepSeqGrid {
    ...
    _build() {
        ...
        // Steps-Feld/Fill/set0 werden NICHT mehr hier in eine gemeinsame .seq-head gehängt,
        // sondern von multiSq.js einzeln über host.mountInGroup() in die Gruppe gemountet
        // (@dpa 20260724_114012: „mach die Elemente im e-mode verschiebbar" — mountInGroup
        // macht ein Element zugleich zum eigenständigen, im e-Mode frei verschiebbaren
        // Control, genau wie beim Sq-Output-PickMenu). Optik bleibt inline-flex (css/main.css
        // .seq-steps-field/.seq-ic), damit sie im NORMALEN Layout weiter wie eine Kopfzeile
        // nebeneinander sitzen — nur im e-Mode werden es drei unabhängige Einheiten.
        const stepsField = document.createElement('div'); stepsField.className = 'seq-steps-field';
        ...
        set0Wrap.appendChild(s0);
        // Nach außen exponiert, damit multiSq.js sie einzeln mounten/registrieren kann
        // (eigene Optik-Settings UND eigene Verschiebbarkeit je Knopf/Feld, wie jeder andere
        ...
        this.stepsField = stepsField; this.fillBtn = fill; this.set0Btn = s0;
        this.fillWrap = fillWrap; this.set0Wrap = set0Wrap;
        this.stepsInput = num; this.stepsLabel = lab;
