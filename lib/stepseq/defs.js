...
export function stepSeqDefs() {
    return {
        ...
        // die grüne, breite Optik + Skala von Sequenzer 0. multiSq.js buildSq() schreibt das als
        ...
        GRID_STYLE: { bg: '#244f4b', fg: '#82ba90', boxSize: 315, boxH: 50, seqOff: false, seqMin: 1, seqMax: 15, seqStep: 1 },
