...
export function createStepSeqEngine(state, getBeatDurMs, onTrigger) {
    ...
    return {
         ...
         * „!!" — „die 1 fällt sofort"). Garantiert korrekt, anders als die Zeit-Heuristik in
         * handleClockBeat: die kann einen Sprung verfehlen, wenn er zufällig nah am alten
         * Raster liegt. Sequenzer fängt sofort neu an, phasengleich mit der neuen 1 —
         * dieselbe Wirkung wie transportStarted(), nur ohne den Transport neu zu starten. */
        resyncPhase() { nextAt = null; beatAnchorMs = null; lastBeatMs = null; resetPending = true; },
