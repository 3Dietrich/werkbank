...
export class LevelMeter {
    ...
    _paintBar(ctx, x, w, h) {
        // Clip-Fläche ZUERST (unterste Ebene, @dpa dd.md 20260802: "Mach diesen Clipbereich
        // bis oben hin, alles andere muss layermäßig obendrauf liegen") — deckt den kompletten
        // Bereich oberhalb der 0dB-Marke ab statt nur einen 3px-Fleck, damit Bar/Hold/RMS
        // (unten, nach diesem Block gezeichnet) sichtbar darüber liegen statt verdeckt zu werden.
