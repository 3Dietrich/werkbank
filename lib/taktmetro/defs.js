...
export function taktMetroDefs(opts = {}) {
    ...
    return {
        ...
        DEFAULTS: {
            ...
            // recFmtBtn-Panel). MP3-Encoder steht (lib/mp3Encoder.js, nur CBR — VBR fehlt
            // lamejs strukturell, @dpa-Entscheidung 20260721), WAV-Encoder fehlt noch
            // (Rec-Instrument-TODO 4) — bis dahin nimmt recStart() unabhängig von recFormat
            // immer webm/opus auf (Verdrahtung folgt mit dem Trimmen, TODO 6).
