...
export function taktMetroDefs(opts = {}) {
    ...
    return {
        ...
        DEFAULTS: {
            ...
            // Aufnahme (@dpa 20260720): Dateiname-Prefix. Format global wählbar (werkbank.js:
            // recFmtBtn-Panel). MP3- und WAV-Encoder stehen (lib/mp3Encoder.js nur CBR — VBR
            // fehlt lamejs strukturell, @dpa-Entscheidung 20260721 — und lib/wavEncoder.js),
            // aber beide sind noch NICHT an recStart() angeschlossen — das passiert erst mit
            // dem Sample-genauen Trimmen (Rec-Instrument-TODO 6); bis dahin nimmt recStart()
            // unabhängig von recFormat immer webm/opus auf.
        ...
        BUTTONS: {
            ...
            // Aufnahme (@dpa 20260720, „erst mal webm/opus"): Klick startet/stoppt, beim
            // Stopp faellt der Download. Nimmt den Master-Ausgang ab (alles Hoerbare), nicht
            // nur das Metronom.
            rec:      btn('⏺ Rec', 'rec', 'Nimmt den Master-Ausgang als webm/opus auf — Klick startet, nochmal Klick stoppt und laedt herunter.', 'toggle'),
        },
