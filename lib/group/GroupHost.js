...
export function mountGroups(root, state, defs, opts = {}) {
    ...
    function setGroupCollapsed(name, on) {
        ...
        // 20260805, „auch die Gruppen-Klappe ist noch nicht überall gefixt"): Free-Canvas-
        // Rahmenmaß (sizeFreeGroup) und Panel-Größe (sizePanel) werden nur EINMAL beim Bau
        // korrekt gemessen, solange alles da schon sichtbar ist — mehrere gezielte Nachmess-
        // Patches an genau diesen Stellen blieben lückenhaft. Pragmatischer Ersatz statt
        // weiterer Flickstellen: beim AUFKLAPPEN neu laden — die Gruppe baut sich dann von
        // Grund auf im sichtbaren Zielzustand auf, exakt wie jede nie eingeklappte Gruppe
        // auch (Zustand ist über MiniState.set() synchron persistiert, bevor reload() greift).
