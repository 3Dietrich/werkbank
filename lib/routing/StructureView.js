...
export function createStructureView(registry, opts = {}) {
    ...
    function open() {
        ...
        // Position merken (ddw.md 20260726, wie groupSettingsPos in GroupHost.js) — opts.posStore
        // ist optional (DI wie bei MiniSettings): ohne ihn altes Verhalten (immer am Opener-Button).
        const savedPos = opts.posStore && opts.posStore.get();
        if (savedPos) {
        ...
        makeDraggable(pop, head, (pos) => { if (opts.posStore) opts.posStore.set(pos); });
