...
export function polySynthDefs(opts = {}) {
    ...
    const ADSR_KNOBS = {
        ...
        adsrLenMs:   { label: 'Len', min: 0, max: 5000, curve: 'linear', unit: ' ms', decimals: 0,
                       title: 'Länge in Millisekunden (0 = 1 Sample) — Trig-Ende, oder bei Gate+fest die Auto-Close-Zeit.' },
        adsrLenBeat: { label: 'Len', min: 0, max: 16,   curve: 'linear', unit: ' beat', decimals: 2, step: 0.25,
    ...
    const ADSR_SETTINGS_NUMS = {
        adsrNullpunkt: { label: 'Nullpunktversatz', min: -10, max: 10, default: 0 },
    };
