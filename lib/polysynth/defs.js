...
export function polySynthDefs(opts = {}) {
    ...
    // Die eigentlichen Gruppen baut der AdsrManager dynamisch (wie Multi-Sq) — hier nur
    // die Template-KNOBS/TOGGLES/SELECTS/DEFAULTS, die pro Instanz indiziert werden.
    const ADSR_KNOBS = {
    ...
    return {
        ...
        ADSR_KNOBS, ADSR_TOGGLES, ADSR_SELECTS, ADSR_DEFAULTS,
