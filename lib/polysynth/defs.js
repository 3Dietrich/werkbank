    ...
    return {
        ...
        ports: {
            ...
            inputs: [
                ...
                // min/max 0..1 deckt den Env-Ausgang (0..1 bzw. -1..1 bei inv) ab.
                { id: 'preQuantMod', label: 'Pre-Quant-Mod', type: 'Value', min: -1, max: 1, stepSize: 0.01, offAllowed: true, group: 'Multi-ADSR' },
                { id: 'postQuantMod', label: 'Post-Quant-Mod', type: 'Value', min: -1, max: 1, stepSize: 0.01, offAllowed: true, group: 'Multi-ADSR' },
            ],
        },
    };
}
