...
export function polySynthDefs(opts = {}) {
    ...
    return {
        ...
        // [R] als latchender Button (@dpa 20260722_004312) statt Toggle — mode 'toggle' heißt
        // hier: Klick schaltet an/aus und der Zustand bleibt sichtbar stehen (kein Impuls).
        BUTTONS: {
