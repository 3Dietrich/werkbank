...
export function polySynthDefs(opts = {}) {
    ...
    const BUTTONS = {
        ...
        // Amp-Env „Fest" (dd.md 20260802, 2. Runde): dieselbe ADSR_BUTTONS-Definition wie
        // Multi-ADSR, unsuffixed. KEIN adsrGate hier — Amp-Env hat keine EINE Instanz, die
        // ein manueller Klick "gaten" könnte (polyphon, eine AdsrCore pro Voice, s. engine.js
        // spawnVoice) — der reale Auslöser ist bereits jede echte Note (Keyboard/MIDI), ein
        // Button ohne adressierbares Ziel wäre nur Attrappe.
