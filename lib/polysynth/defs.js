...
export function polySynthDefs(opts = {}) {
    ...
    //
    // Bausteine (Knobs/Buttons/Settings/Defaults) kommen seit @dpa 20260803 aus
    // lib/adsrPanel.js — EINE Quelle statt Kopien in jedem ISM mit eigener ADSR (s.
    // docs/CONTROLS.md „Rezept: Klang-Baustein bauen" für den Auslöser).
    const ADSR_BUTTONS = adsrButtons(onAction);
    const ADSR_KNOBS = adsrKnobs();
