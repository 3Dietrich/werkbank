...
export function polySynthDefs(opts = {}) {
    ...
    return {
        DEFAULTS: {
            ...
            oscTilt: 0,         // Obertonreihen-Gewichtung (@dpa ddw.md 20260723_230925, Korrektur des
                                // ersten Versuchs): 0=alle Obertöne unverändert (100%), 100=Grundton
                                // bleibt, jeder Oberton n fadet auf ≈1/n (Sägezahn-Obertonreihe), >100
                                // extrapoliert dieselbe Gerade (kann invertieren, bewusst ungeklemmt —
                                // "kann ich selbst herausfinden ob das Sinn macht"). S. pulseWave.js
                                // applyHarmonicTilt() — wirkt beim Backen der Wellenform, nicht als
                                // Laufzeit-Gain.
