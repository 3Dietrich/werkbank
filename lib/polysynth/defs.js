...
export function polySynthDefs(opts = {}) {
    return {
        DEFAULTS: {
            ...
            akio: false,        // gebündeltes Gate für den aktuellen Akkord (On/Off-Toggle)
            akReset: false,     // [R]: belegten Slot drücken LÖSCHT ihn, statt ihn abzurufen
        ...
        TOGGLES: {
            ...
            akio:       { label: 'AkIO', title: 'Akkord-Ein/Aus: schickt ALLE aktiven Tasten als EIN gebündeltes Gate an den Synth. Aus = der ganze Akkord verstummt (der Zustand bleibt gemerkt), An = er klingt wieder. Ein Speicher-Recall schaltet AkIO automatisch an.' },
            akReset:    { label: 'R', title: 'Reset-Modus für den Akkord-Speicher: solange aktiv, LÖSCHT ein Klick auf einen belegten Slot dessen Akkord, statt ihn abzurufen.' },
        },
