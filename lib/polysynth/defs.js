...
export function polySynthDefs(opts = {}) {
    ...
    return {
        ...
        BUTTONS: {
            akReset: { label: 'R', mode: 'toggle', title: 'Akkord-Speicher-Modus durchschalten: aus → rename (Klick auf Slot vergibt ein Kürzel) → reset (Klick löscht den Slot) → aus.', onClick: () => onAction('akReset') },
