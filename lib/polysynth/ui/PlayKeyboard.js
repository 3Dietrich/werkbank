...
export class PlayKeyboard {
    ...
    constructor(state, engine) {
        ...
        state.subscribe((k) => {
            ...
            else if (k === 'akio') this._onAkioChange();
        });
    }
    ...
    _recall(notes) {
        ...
        // AkIO mit anschalten (ddw.md: „AkIO muss mit den Speicherabrufen mit angehen") — der
        // akio-Subscribe schlägt die neuen NoteOns an. War AkIO schon an, feuert set() trotzdem.
        if (this.state.get('akio')) this._onAkioChange();
        else this.state.set('akio', true);
    }
