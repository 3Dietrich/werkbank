...
export function createEnvManager({ host, state, defs, tpl, routing, getBpm }) {
    ...
    function buildEnv(i) {
        ...
        // Gate-Button (manuelles Triggern) — als eigenes Control, damit es im
        // e-Mode verschiebbar ist und Element-Settings per Rechtsklick bekommt.
        ...
        host.mountInGroup(envName(i), gateWrap, 'b:adsrGate' + sfx);
